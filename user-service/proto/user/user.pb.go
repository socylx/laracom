...
var file_proto_user_user_proto_rawDesc = []byte{
	...
	0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x75, 0x73, 0x65, 0x72, 0x22, 0xfe, 0x02,
	...
	0x0a, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x71, 0x0a, 0x08, 0x52, 0x65, 0x73,
	...
	0x52, 0x05, 0x75, 0x73, 0x65, 0x72, 0x73, 0x12, 0x23, 0x0a, 0x06, 0x65, 0x72, 0x72, 0x6f, 0x72,
	...
	0x64, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x32, 0x85, 0x01, 0x0a, 0x0b,
...
var file_proto_user_user_proto_depIdxs = []int32{
	...
	0, // 3: user.UserService.Create:input_type -> user.User
	0, // 4: user.UserService.Get:input_type -> user.User
	1, // 5: user.UserService.GetAll:input_type -> user.Request
	2, // 6: user.UserService.Create:output_type -> user.Response
	2, // 7: user.UserService.Get:output_type -> user.Response
	2, // 8: user.UserService.GetAll:output_type -> user.Response
